...
public class Main {
    public static void main(String[] args) {
        ...
        Bus bus1 = new Bus("Бекошин", 130, 2, "НеФАЗ-5299", 2024, 1000);
        Bus bus2 = new Bus("Гурбанович", 122, 2, "НеФАЗ-5299", 2024, 1500);
        Bus bus3 = new Bus("Омельчук", 542, 8, "ЛиАЗ-5292", 2021, 4000);
        Bus bus4 = new Bus("Богданов", 1308, 18, "МАЗ-103", 2017, 15000);
        Bus bus5 = new Bus("Руденко", 509, 12, "ЛиАЗ-5292", 2019, 12000);
        Bus bus6 = new Bus("Кряжев", 109, 9, "НеФАЗ-5299", 2024, 2000);
        Bus bus7 = new Bus("Демидова", 717, 7, "МАЗ-103", 2013, 24000);
